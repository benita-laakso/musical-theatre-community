    ...
    <div className="item intro-grid">
      <div className="item intro_item">
        ...
        <p>
          ...
          for music, theatre and dance. Valentina Garcia runs the theater and
          she has hade numerouse roles since the theatre oapend in 2001.{" "}
        </p>
        <div className="valentina ">
          ...
          <p>
            ...
            her own theatre, whre she has all the creative freedom that she ahas
          ...
          <p>
            <i>"Valentina is very down to earth and easy to work with"</i>{" "}
            <br></br> Madeline Lead dancer
          </p>
        </div>
      </div>
      <div className="item item-intro intro-img">
        <img
          className="gallery-pik brighter"
          src={theresia}
          alt="opera singer"
        ></img>
      </div>
